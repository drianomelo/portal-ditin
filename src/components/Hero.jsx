export const Hero = () => {
  return (
    <div className="w-full h-screen flex-1 flex justify-center items-center relative overflow-hidden ">
      <div className="w-[2000px] h-[2000px] bg-[#010614] absolute rounded-full top-32 shadow-azul animate-girar-lento">
      ...
      <div className="relative flex flex-col items-center mt-24">
        <h2 className="flex items-center font-medium text-lg gap-2 mb-4">
          Diretoria de Tecnologia da Informação
          <a
            href="/"
            className="flex items-center text-base gap-3 bg-[#43464e75] py-1.5 font-medium px-3 rounded-xl border-2 border-[#ffffff2a] transition-all hover:opacity-100 hover:bg-[#43464e75] hover:border-[#ffffff2a]"
          >
            <img
              className="w-5"
        ...
        <h1 className="text-7xl max-w-4xl text-center mb-8">
